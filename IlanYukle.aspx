<%@ Page Language="VB" AutoEventWireup="false" 
         CodeBehind="IlanYukle.aspx.vb" 
         Inherits="Serhan_Satis.IlanYukle"
...
<body>
    <form id="form1" runat="server">
        <div class="ilan-form-container">
            ...
            <%-- 1. SATIR: İlan Başlığı (Tek Sütun, tam genişlik) --%>
            ...
            <%-- 2. SATIR: Kategori, Durum, Fiyat (YAN YANA 3 SÜTUN) --%>
            ...
            <%-- 3. SATIR: Şehir ve Telefon (YAN YANA 2 SÜTUN) --%>
            ...
            <%-- 4. SATIR: Açıklama (Tek Sütun - Geniş kalmalı) --%>
            <div class="form-group">
            ...
            <%-- 5. SATIR: Resim Yükle (GÜNCELLENMİŞ STİL) --%>
            <div class="form-group">
                ...
                <div class="file-upload-wrapper">
                    ...
                    <%-- Özelleştirilmiş görünüm (Label, gerçek input'a bağlıdır) --%>
                    <label for="<%= fuResim.ClientID %>" class="custom-file-upload">
                        <span id="fileName" class="file-name-display">Dosya seçilmedi...</span>
                        <span class="custom-file-upload-button">Dosya Seç</span>
                    </label>
                </div>
                
                <asp:CustomValidator ID="CustomValidatorResim" runat="server" ErrorMessage="Lütfen bir resim dosyası yükleyin." OnServerValidate="CustomValidatorResim_ServerValidate" CssClass="error-message" Display="Dynamic"></asp:CustomValidator>
            </div>

            <%-- İlanı Yayınla Butonu --%>
            <asp:Button ID="btnIlanEkle" runat="server" Text="İlanı Yayınla" CssClass="btn-yayinla" OnClick="btnIlanEkle_Click" />
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // ASP.NET tarafından oluşturulan ClientID'yi al
            ...
            if (fileInput) {
                fileInput.addEventListener('change', function () {
                    if (this.files && this.files.length > 0) {
                        ...
                        // Dosya seçilmediyse varsayılan metni göster
