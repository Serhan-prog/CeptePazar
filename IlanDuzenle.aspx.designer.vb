...
Partial Public Class IlanDuzenle
    ...
    '''Değiştirmek için, alan bildirimini tasarımcı dosyasından arka plan kod dosyasına taşıyın.
    '''</remarks>
    Protected WithEvents hfIlanID As Global.System.Web.UI.WebControls.HiddenField
    ...
    '''<summary>
    '''pnlMevcutResim denetimi.
    '''</summary>
    '''<remarks>
    '''Otomatik üretilmiş alan.
    '''Değiştirmek için, alan bildirimini tasarımcı dosyasından arka plan kod dosyasına taşıyın.
    '''</remarks>
    Protected WithEvents pnlMevcutResim As Global.System.Web.UI.WebControls.Panel

    '''<summary>
    '''imgMevcutResim denetimi.
    '''</summary>
    '''<remarks>
    '''Otomatik üretilmiş alan.
    '''Değiştirmek için, alan bildirimini tasarımcı dosyasından arka plan kod dosyasına taşıyın.
    '''</remarks>
    Protected WithEvents imgMevcutResim As Global.System.Web.UI.WebControls.Image
    ...
    '''<summary>
    '''btnIlanGuncelle denetimi.
    '''</summary>
    '''<remarks>
    '''Otomatik üretilmiş alan.
    '''Değiştirmek için, alan bildirimini tasarımcı dosyasından arka plan kod dosyasına taşıyın.
    '''</remarks>
    Protected WithEvents btnIlanGuncelle As Global.System.Web.UI.WebControls.Button
